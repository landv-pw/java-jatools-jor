...
public class TextIcon implements Icon, PropertyChangeListener {
	...
	static final double NINETY_DEGREES = Math.toRadians(45.0);
	 ...
	 * @see #verifyRotation
	 */
	public TextIcon(Component component, String label) {
	 ...
	 * @see #verifyRotation
	 */
	public TextIcon(Component component, String label, int rotateHint) {
