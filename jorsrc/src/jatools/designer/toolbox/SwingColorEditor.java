...
public class SwingColorEditor extends SwingEditorSupport { 
    ...
    private void createComponents(){
        ...
        table.put("beaninfo.ColorIcon",  
		  LookAndFeel.makeIcon(getClass(), "/jatools/icons/new.gif"));
        table.put("beaninfo.ColorPressedIcon", 
		  LookAndFeel.makeIcon(getClass(), "/jatools/icons/new.gif"));
        Icon colorIcon = Util.getIcon("/jatools/icons/new.gif"); 
        Icon colorPressedIcon = Util.getIcon("/jatools/icons/new.gif");
