...
public class PngEncoder
{
     ...
     * @param width1 Width of a scanline in pixels.
     */
    protected void filterSub( byte[] pixels, int startPos, int width1 )
    {
        int i;
        int offset = bytesPerPixel;
        int actualStart = startPos + offset;
        int nBytes = width1 * bytesPerPixel;
     ...
     * @param width1 Width of a scanline in pixels.
     */
    protected void filterUp( byte[] pixels, int startPos, int width1 )
    {
        int     i, nBytes;
        byte    current_byte;

        nBytes = width1 * bytesPerPixel;
